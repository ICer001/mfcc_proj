...
--               e:/Xilinx/project_lvbo/project_lvbo.srcs/sources_1/ip/dist_mem_gen_0/dist_mem_gen_0_sim_netlist.vhdl
...
architecture STRUCTURE of dist_mem_gen_0_dist_mem_gen_v8_0_12 is
  ...
  signal \^spo\ : STD_LOGIC_VECTOR ( 15 downto 10 );
begin
  dpo(15) <= \<const0>\;
  dpo(14) <= \<const0>\;
  dpo(13) <= \<const0>\;
  ...
  spo(9 downto 6) <= \^spo\(13 downto 10);
  spo(5 downto 2) <= \^spo\(13 downto 10);
  spo(1 downto 0) <= \^spo\(13 downto 12);
...
\synth_options.dist_mem_inst\: entity work.dist_mem_gen_0_dist_mem_gen_v8_0_12_synth
     port map (
      a(7 downto 0) => a(7 downto 0),
      clk => clk,
      spo(5 downto 0) => \^spo\(15 downto 10)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
